...
<?php
	...
	$groupFields = 2;	// How many rows
	$orFields = 8;	// How many rows
...
<body>
	...
	<h1>Create your course requirements <?php echo $_COOKIE['ID_my_site']; ?>!</h1>
	<br>
		...
		<table border="1">
			...
			for($i = 0; $i<$groupFields; $i++)
			{
				...
				echo "<tr>\n";
					for($j = 0; $j < 4; $j++)
					{
						echo "<td><input type=\"text\" name\=\"B_course" . $elementCounter . "\" maxlength\=\"5\" size\=\"4\"></td>\n";
						echo "<td><input type=\"text\" name\=\"B_crs_num" . $elementCounter . "\"maxlength\=\"5\" size\=\"4\"></td>\n";
						if($j != 3)
						{
							echo "<td>&nbsp;</td>\n";
						}
		...
		<table border="1">
			...
			for($i = 0; $i<$groupFields; $i++)
			{
				...
				echo "<tr>\n";
					for($j = 0; $j < 3; $j++)
					{
						echo "<td><input type=\"text\" name\=\"B_course" . $elementCounter . "\" maxlength\=\"5\" size\=\"6\"></td>\n";
						echo "<td><input type=\"text\" name\=\"B_crs_num" . $elementCounter . "\"maxlength\=\"5\" size\=\"6\"></td>\n";
						if($j != 2)
						{
							echo "<td>OR</td>\n";
						}
